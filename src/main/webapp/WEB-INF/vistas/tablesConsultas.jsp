        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Registro Consultas</h1>
                    <p class="mb-4">En esta seccion podra encontrar todas las consultas que los clientes realizan por medio de nuestra pagina web.</p>
