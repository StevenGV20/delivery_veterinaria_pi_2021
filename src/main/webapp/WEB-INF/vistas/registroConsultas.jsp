    ...
    <body>
        ...
        <div class="login">
            <div class="container-fluid">
                        <form action="registroConsultas" method="post" id="idRegistroConsultas" class="register-form" data-toggle="validator">
                            <div class="row">
                            	<h4 align="center" class="col-md-12">INGRESE SU CONSULTA</h4>
                                <div class="col-md-6">
	                                <label for="staticEmail">Nombre</label>
									<input class="form-control" id="idnombre" name="nombre" placeholder="Ingrese Nombre"/>
	                             </div>    
	                             <div class="col-md-6">
	                                <label for="staticEmail">Registre su consulta</label>
								   	<input class="form-control" id="idregConsulta" name="regConsulta" placeholder="Ingrese su Consulta">
	                              </div>
	                              <div class="col-md-6">
	                                <label for="staticEmail">Fecha</label>
									<input class="form-control" id="idfechaConsulta" name="fechaConsulta" placeholder="Ingrese la fecha"/>
	                              </div> 
...
$("#id_registrar").click(function (){ 
	...
	var validator = $('#idRegistroConsultas').data('bootstrapValidator');
	validator.validate();

	if (validator.isValid()){
		$.ajax({
			type: 'POST',  
			data: $("#idRegistroConsultas").serialize(),
...
$('#idRegistroConsultas').bootstrapValidator({
